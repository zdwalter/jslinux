...
Term.prototype.write=function(ta){
    ...
    for(i=0;
        ...
        switch(this.state){
            case ya:switch(c){
                        case 10:if(this.convert_lf_to_crlf){
                                    this.x=0;
                                }
                                this.y++;
                                if(this.y>=this.h){
            ...
            case Aa:if(c>=48&&c<=57){
                        ...
                        this.state=ya;
                        switch(c){
                            case 65:n=this.esc_params[0];
                                    if(n<1)n=1;
                                    this.y-=n;
                                    if(this.y<0)this.y=0;
                                    break;
                            case 66:n=this.esc_params[0];
                                    if(n<1)n=1;
                                    this.y+=n;
                                    if(this.y>=this.h)this.y=this.h-1;
                                    break;
                            case 67:n=this.esc_params[0];
                                    if(n<1)n=1;
                                    this.x+=n;
                                    if(this.x>=this.w-1)this.x=this.w-1;
                                    break;
                            case 68:n=this.esc_params[0];
                                    if(n<1)n=1;
                                    this.x-=n;
                            ...
                            case 72:{
                                    ...
                                    break;
                            case 74:va(this,this.x,this.y);
                                    for(j=this.y+1;
                                            j<this.h;
                                            j++)va(this,0,j);
                                    break;
                            case 75:va(this,this.x,this.y);
                                    break;
                            case 109:wa(this,this.esc_params);
                                     break;
                            case 110:this.queue_chars("\x1b["+(this.y+1)+";"+(this.x+1)+"R");
                                     break;
                            default:break;
                        }
                    }
